...
class FrontController extends Controller
{
    ...
    // 原公司基本資料
    public function basic_info0($id)
    {
    ...
    public function finance($id)
    {
        ...
        // dd($no);
        // dd($jsonbasic);
        $jsonbasic = shell_exec("python python/用ajax爬財務比率匯入到laravel.py $no");
        // dd($jsonbasic);
        $finance_data = json_decode($jsonbasic);
        // dd($finance_data);
        return view('front/finance', compact('finance_data','id'));
    ...
    public function concall0($id)
    {
        ...
        $jsonbasic = file_get_contents('python/concall/concall.json');
...
// 20200321法說會
    public function concall($id)
    {
        ...
        // $jsonbasic = json_decode($jsonbasic);
        // dd($jsonbasic);
        $concall_data = Concall::where('stock_id', $id)->first();
        return view('front/concall', compact('concall_data','id'));
    }
