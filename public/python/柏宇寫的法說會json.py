# -*- coding: utf-8 -*-
"""
Created on Mon Mar 30 23:00:14 2020
            ...
            try:
                ...
                for vel,index in enumerate(dfs[0][1]):
                    if (index == '法人說明會簡報內容'):
                        ...
                        Data[stockVar][str(vel+1)+' '+index] = str(dfs[0][3][vel])
                #with open('C:/Users/lulu/Documents/GitHub/StockIntegrationPlatform_vue/public/python/concall/concall.json', 'w',encoding='utf-8') as f:
                    #json.dump(Data, f)
